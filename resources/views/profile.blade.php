                        ...
                        <div class="row m-l-0 m-r-0">
                            ...
                            <div class="col-sm-8">
                                <div class="card-block">
                                    ...
                                    <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Site Information</h6>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Joined</p>
                                            <h6 class="text-muted f-w-400">{{$info->created_at->diffForHumans()}}</h6>
                                        </div>
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Votes</p>
                                            <h6 class="text-muted f-w-400">{{$info->points}}</h6>
                                        </div>
                                    </div>
